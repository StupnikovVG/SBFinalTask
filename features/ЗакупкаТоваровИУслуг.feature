...
Функционал: Закупка товаров и услуг
	Как Оператор
	Хочу фиксировать поступление товаров документом Покупка
...
Сценарий:
	...
	И Я удаляю документы вида "ЗакупкаТоваровИУслуг" по контрагенту "000000002"
	...
	И я выбираю товары
		...
		И     В форме "Покупка (создание) *" в ТЧ "Номенклатура" я завершаю редактирование строки
		Тогда открылось окно "Покупка (создание) *"
		И     в ТЧ "Номенклатура" я нажимаю на кнопку "Добавить"
		И     в ТЧ "Номенклатура" я выбираю значение реквизита "Номенклатура" из формы списка
		Тогда открылось окно "Номенклатура"
