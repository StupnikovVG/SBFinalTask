...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляСценарияПродажа()","ЯПодготавливаюВспомогательныеДанныеДляСценарияПродажа","Допустим Я Подготавливаю вспомогательные данные для сценария продажа","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПроверяюСообщениеПользователю()","ЯПроверяюСообщениеПользователю","И Я проверяю сообщение пользователю","","");
...
//@ЯПодготавливаюВспомогательныеДанныеДляСценарияПродажа()
Процедура ЯПодготавливаюВспомогательныеДанныеДляСценарияПродажа() Экспорт
...
//@ЯПроверяюСообщениеПользователю()
Процедура ЯПроверяюСообщениеПользователю() Экспорт
	
	ОкноПриложенияПродажаОт = Ванесса.ОбъектКонтекстСохраняемый.ТестовоеПриложение.НайтиОбъект(Тип("ТестируемоеОкноКлиентскогоПриложения"), "Продажа * от * *", , 30);
	ТекстыСообщений = ОкноПриложенияПродажаОт.ПолучитьТекстыСообщенийПользователю();
	
	Если НЕ ТекстыСообщений[ТекстыСообщений.Количество() - 1] = "Документ успешно проведен." Тогда
