...
&НаСервере
Процедура УдалитьДокументыНаСервере(ВидДокумента, Контрагент)
...
Процедура ЯУдаляюДокументыВидаПоКонтрагенту(ВидДокумента, Контрагент) Экспорт
	УдалитьДокументыНаСервере(ВидДокумента, Контрагент);
КонецПроцедуры
